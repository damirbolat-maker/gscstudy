  ...
  ru: {
    ...
    countries: {
      ...
      more: {
        ...
        text: "Работаем по всем ключевым направлениям — подберём страну под ваш бюджет, специальность и цель.",
        list: [
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Можно ли учиться бесплатно?", a: "Полностью бесплатно — редко, но реально: в госвузах некоторых стран нет платы за обучение, остаются только сбор за семестр и расходы на жизнь. Чаще речь о частичном покрытии — стипендии и гранты, но они конкурсные и требуют высоких баллов." },
  ...
  kz: {
    ...
    countries: {
      ...
      more: {
        ...
        text: "Барлық негізгі бағыттармен жұмыс істейміз — бюджетіңізге, мамандығыңызға және мақсатыңызға сай ел таңдаймыз.",
        list: [
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Тегін оқуға бола ма?", a: "Толықтай тегін — сирек, бірақ мүмкін: кейбір елдердің мемлекеттік ЖОО-ларында оқу ақысы жоқ, тек семестрлік жарна мен өмір сүру шығыны қалады. Көбіне ішінара жабу туралы сөз — стипендия мен грант, бірақ олар конкурстық және жоғары балл талап етеді." },
  ...
  en: {
    ...
    countries: {
      ...
      more: {
        ...
        text: "We cover every key destination — we'll match a country to your budget, major and goal.",
        list: [
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Can you study for free?", a: "Fully free is rare but real: some countries' state universities charge no tuition, leaving only a semester fee and living costs. More often it's partial coverage — scholarships and grants, which are competitive and require high scores." },
